...
/// Clean pagination controls widget for the Inventory workspace.
class InventoryPaginationControls extends StatelessWidget {
  ...
  const InventoryPaginationControls({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final rangeText = Text(
      ...
      key: const Key('inventory_pagination_range_text'),
      maxLines: 1,
    ...
    final pageText = Text(
      ...
      key: const Key('inventory_pagination_page_text'),
      maxLines: 1,
      style: theme.textTheme.bodySmall?.copyWith(
    ...
    final previousButton = OutlinedButton.icon(
      key: const Key('inventory_pagination_previous_button'),
    ...
    final nextButton = OutlinedButton(
      key: const Key('inventory_pagination_next_button'),
