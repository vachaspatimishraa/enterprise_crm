...
void main() {
  group('Inventory Screens Responsive & Theme Layout Tests', () {
    ...
    for (final entry in viewports.entries) {
      testWidgets(
        'InventoryWorkspaceScreen renders cleanly at ${entry.key} without overflow',
        (tester) async {
          ...
          await tester.pumpWidget(
            MaterialApp(
              ...
              home: InventoryWorkspaceScreen(user: user, repository: repo),
            ),
          );
      ...
      testWidgets(
        'InventoryItemDetailsScreen renders cleanly at ${entry.key} without overflow',
        (tester) async {
          tester.view.physicalSize = entry.value;
          tester.view.devicePixelRatio = 1.0;
          addTearDown(tester.view.resetPhysicalSize);
